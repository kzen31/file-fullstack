          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
                    ...
                    >
                      ...
                      <div className="mb-0 row">
                        <div className="col-12 mt-4">
                          <p className="text-muted mb-0 font-size-14">By registering you agree to the ASA <Link to="#" className="text-primary">Terms of Use</Link></p>
                        </div>
                      </div>
                    </AvForm>
                  </div>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} ASA <span className="d-none d-sm-inline-block">  - by Asa Team IT.</span>
                </p>
              </div>
            </Col>
          </Row>
